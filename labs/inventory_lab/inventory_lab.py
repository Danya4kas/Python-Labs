...
if __name__ == "__main__":
    inv = Inventory()
    inv.add_item(Item("Радіолампа", "електроніка", 3, 145.0, "вживаний", "гараж"))
    inv.add_item(Item("Гаечний ключ", "інструменти", 2, 280.0, "вживаний", "комора"))
    inv.add_item(Item("Молоток", "інструменти", 4, 450.0, "новий", "комора"))
